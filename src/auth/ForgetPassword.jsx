    ...
    const handleSubmit=async(e)=>{
        ...
        try{
          await  sendPasswordResetEmail(__AUTH,email)
            toast.success("Resent link sent to mail")
             navigate("/")
        }
        catch(error){
   ...
   <section className='h-[calc(100vh-70px)] w-[100%] bg-slate-900 flex justify-center items-center'>
         <div className='w-[30%] p-4 rounded-lg bg-slate-600'>
           ...
           <main className='p-2'>
             ...
             <div>
               <button className='outline-none py-2  hover:bg-slate-700 w-[100%] cursor-pointer rounded bg-slate-900 mt-2'>Reset Password</button>
             </div>
